...
class CityDevCard(CatanBaseEnv):
    """
    ...
    def __init__(self, customBoard=None, players=None, trading=False):
        super(CityDevCard, self).__init__(customBoard=customBoard, players=players, trading=trading)
    ...
    def reset(self, seed=None):
        self.numTurns = 0
        return super(CityDevCard, self).reset()
...
class SettlementLRoad(CatanBaseEnv):
    """
    Full Catan game with full action and state space (no player trades)
    Change the rewards when certain reward reached
    """
    def __init__(self, customBoard=None, players=None, trading=False):
        super(SettlementLRoad, self).__init__(customBoard=customBoard, players=players, trading=trading)
    ...
    def reset(self, seed=None):
        self.numTurns = 0
        return super(SettlementLRoad, self).reset()
