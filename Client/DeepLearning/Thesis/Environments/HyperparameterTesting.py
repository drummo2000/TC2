...
class HyperParamEnv(CatanBaseEnv):
    """
    ...
    def __init__(self, customBoard=None, players=None, trading=False, lowerBounds=None, upperBounds=None, getObservationFunction=None, getActionMaskFunction=None):
        super(HyperParamEnv, self).__init__(customBoard=customBoard, players=players, trading=trading)
    ...
    def reset(self, seed=None):
        ...
        return super(HyperParamEnv, self).reset()
