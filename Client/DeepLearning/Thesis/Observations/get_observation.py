...
otherInfoLowerBound = 45*[0]
otherInfoUpperBound = 5*[10] + 5*[10] + [10] + [1] + 5*[4] + [10] + [1] + [15] + [1] + 9*[1] + 5*[40] + [1] + 8*[1] + [150]
# Total: 45
...
lowerBound = np.array([*otherInfoLowerBound, *hexsLowerBound, *edgesLowerBound])
upperBound = np.array([*otherInfoUpperBound, *hexsLowerBound, *edgesUpperBound])
# 1804
def getObservation(gameState: GameState, playerNumber=0):
    """
