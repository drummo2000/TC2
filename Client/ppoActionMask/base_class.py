...
class BaseAlgorithm(ABC):
    ...
    def _setup_learn(
        ...
        if reset_num_timesteps or self._last_obs is None:
            ...
            print(type(self.env))
            self._last_obs, info = self.env.reset()  # type: ignore[assignment]
            self._last_action_mask = info["ActionMask"]
    ...
    def predict(
        ...
        """
        return self.policy.predict(observation, state, episode_start, deterministic, action_mask)
